...
class PConvUNet(nn.Module):
    def __init__(self, img_channels=3):
        ...
        self.e6 = EncoderLayer(img_channels * 64, kernel_size=3, depth_multiplier=2)
        self.e7 = EncoderLayer(img_channels * 128, kernel_size=3, depth_multiplier=1)
        
        bottle_neck = img_channels * 128
        
        self.d1 = DecoderLayer(bottle_neck, bottle_neck, kernel_size=3)

        
        self.d2 = DecoderLayer(bottle_neck, bottle_neck//2, kernel_size=3)
        self.d3 = DecoderLayer(bottle_neck//2, bottle_neck//4, kernel_size=3)
        self.d4 = DecoderLayer(bottle_neck//4, bottle_neck//8, kernel_size=3)
        self.d5 = DecoderLayer(bottle_neck//8, bottle_neck//16, kernel_size=3)
        self.d6 = DecoderLayer(bottle_neck//16, bottle_neck//32, kernel_size=3)
        self.d7 = DecoderLayer(bottle_neck//32, img_channels, kernel_size=3)
    ...
    def forward(self, inputs_img, inputs_mask):
        ...
        # dconv2, dmask2 = self.d2(e_conv6, e_mask6, e_conv5, e_mask5)
